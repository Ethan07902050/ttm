...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 video_cls_token_num=3, dropout=0.):
        super().__init__()
...
class TimeSformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, num_classes=400, num_frames=8, attention_type='divided_space_time',  video_cls_token_num=3, pretrained_model='', **kwargs):
        ...
        self.model = VisionTransformer(img_size=img_size, 
                                        ...
                                        drop_path_rate=0.1, num_frames=num_frames, 
